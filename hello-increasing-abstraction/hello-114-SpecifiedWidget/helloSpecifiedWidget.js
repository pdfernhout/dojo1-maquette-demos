define(["require", "exports", "maquette", "dojo/request"], function (require, exports, maquette, request) {
    var dojoString = {
        startsWith: function (theString, searchString, position) {
            position = position || 0;
            return theString.substr(position, searchString.length) === searchString;
        }
    };
    var h = maquette.h;
